...
//        view.layer.addSublayer(gradientLayer)
    ...
    func configure(){
        models.append(contentsOf: [
            CourceOption(name: "AMD", currency: "Armenia", course: "1", backgroundColor: .darkGray, backgroundImage: UIImage(named: "Armenia")!),
            CourceOption(name: "RUB", currency: "Russia", course: "1", backgroundColor: .darkGray, backgroundImage: UIImage(named: "Russia")!),
            CourceOption(name: "USD", currency: "USA", course: "1", backgroundColor: .darkGray, backgroundImage: UIImage(named: "USA")!),
            CourceOption(name: "EUR", currency: "Europe", course: "1", backgroundColor: .darkGray, backgroundImage: UIImage(named: "Europe")!),
            CourceOption(name: "GEL", currency: "Georgia", course: "1", backgroundColor: .darkGray, backgroundImage: UIImage(named: "Georgia")!),
            CourceOption(name: "KZT", currency: "Kazakhstan", course: "1", backgroundColor: .darkGray, backgroundImage: UIImage(named: "Kazakhstan")!),
            CourceOption(name: "AED", currency: "UAE", course: "1", backgroundColor: .darkGray, backgroundImage: UIImage(named: "UAE")!),
            ...
            CourceOption(name: "BYN", currency: "Belarus", course: "1", backgroundColor: .darkGray, backgroundImage: UIImage(named: "Belarus")!),
            ...
            CourceOption(name: "IRR", currency: "Iran", course: "1", backgroundColor: .darkGray, backgroundImage: UIImage(named: "Iran")!),
            CourceOption(name: "MDL", currency: "Moldova", course: "1", backgroundColor: .darkGray, backgroundImage: UIImage(named: "Moldova")!),
            CourceOption(name: "NOK", currency: "Norway", course: "1", backgroundColor: .darkGray, backgroundImage: UIImage(named: "Norway")!),
            CourceOption(name: "SEK", currency: "Sweden", course: "1", backgroundColor: .darkGray, backgroundImage: UIImage(named: "Sweden")!),
            CourceOption(name: "UAH", currency: "Ukraine", course: "1", backgroundColor: .darkGray, backgroundImage: UIImage(named: "Ukraine")!),
            CourceOption(name: "GBP", currency: "Uited Kingdom", course: "1", backgroundColor: .darkGray, backgroundImage: UIImage(named: "United Kingdom")!),
            CourceOption(name: "UYU", currency: "Uruguay", course: "1", backgroundColor: .darkGray, backgroundImage: UIImage(named: "Uruguay")!),
